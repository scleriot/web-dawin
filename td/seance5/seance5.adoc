...
Le state de l'application est aussi réactif que les variables définies dans _data_, elles seront mises à jour automatiquement dès qu'elles auront été modifiées.
